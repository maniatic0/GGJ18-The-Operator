...
public class EndingHandler : MonoBehaviour
{
    ...
    private void Start()
    {
		...
		goverment_ending = "Mr. President proved his power one more time! Our legendary army forced back all the rebel movement. These traitors couldn’t managed to kill our democracy. Live long the president! ";
